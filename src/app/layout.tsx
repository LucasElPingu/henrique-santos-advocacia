...
export const metadata: Metadata = {
  ...
  title: 'Henrique Santos Advocacia | Escritório de Advocacia em João Pessoa, PB',
  // Descrição otimizada: Um texto claro e profissional que inclui palavras-chave importantes.
  description: 'Escritório de advocacia em João Pessoa, Paraíba, com atuação séria e comprometida. Oferecemos soluções jurídicas personalizadas em diversas áreas do direito, incluindo Direito de Família, Empresarial e do Consumidor. Entre em contacto para uma consultoria especializada.',
  // Keywords: Embora o Google não as use para ranking, não custa adicioná-las.
  keywords: ['advogado em joão pessoa', 'henrique santos advocacia', 'escritório de advocacia paraíba', 'direito de família', 'direito empresarial'],
